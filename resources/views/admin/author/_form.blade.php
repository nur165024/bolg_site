<div class="form-group">
    ...
    <input type="text" name="name" value="{{ old('name',isset($author) ? $author->name:null) }}" id="name" placeholder="Enter your Author Name" class="form-control">
</div>

<div class="form-group">
    <label for="details" class="form-control-label">Author details</label>
    <textarea name="details" id="details" placeholder="Enter your Author Details" class="form-control" rows="10">{{ old('details',isset($author) ? $author->details:null) }}</textarea>
</div>
